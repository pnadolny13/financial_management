...
ssh ec2-user@$1 "sudo docker-compose -f /home/ec2-user/docker-compose.prod.yml up -d; sudo docker-compose -f /home/ec2-user/docker-compose.prod.yml exec -T web python manage.py collectstatic --no-input --clear;"
